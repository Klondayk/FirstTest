...
var _AdditionalMergePersonInfo = _interopRequireDefault(require("./AdditionalMergePersonInfo"));
 ...
 * @version 1.0.0
 */
var MergePersonItem = /*#__PURE__*/function () {
  /**
   ...
   */
  function MergePersonItem() {
    (0, _classCallCheck2["default"])(this, MergePersonItem);

    _BasePersonItem["default"].initialize(this);

    _AdditionalMergePersonInfo["default"].initialize(this);
  ...
  (0, _createClass2["default"])(MergePersonItem, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _AdditionalMergePersonInfo["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('participant_open_deals_count')) {
          obj['participant_open_deals_count'] = _ApiClient["default"].convertToType(data['participant_open_deals_count'], 'Number');
          delete data['participant_open_deals_count'];
        }

        if (data.hasOwnProperty('participant_closed_deals_count')) {
          obj['participant_closed_deals_count'] = _ApiClient["default"].convertToType(data['participant_closed_deals_count'], 'Number');
...
MergePersonItem.prototype['participant_closed_deals_count'] = undefined; // Implement BasePersonItem interface:
...
_BasePersonItem["default"].prototype['cc_email'] = undefined; // Implement AdditionalMergePersonInfo interface:
...
_AdditionalMergePersonInfo["default"].prototype['owner_id'] = undefined;
/**
 * The ID of the organization related to the person
 * @member {Number} org_id
 */

_AdditionalMergePersonInfo["default"].prototype['org_id'] = undefined;
/**
 * The ID of the person with what the main person was merged
 * @member {Number} merge_what_id
 */

_AdditionalMergePersonInfo["default"].prototype['merge_what_id'] = undefined;
/**
 * The name of the person
 * @member {String} name
 */

_AdditionalMergePersonInfo["default"].prototype['name'] = undefined;
/**
 * The first name of the person
 * @member {String} first_name
 */

_AdditionalMergePersonInfo["default"].prototype['first_name'] = undefined;
/**
 * The last name of the person
 * @member {String} last_name
 */

_AdditionalMergePersonInfo["default"].prototype['last_name'] = undefined;
/**
 * The count of email messages related to the person
 * @member {Number} email_messages_count
 */

_AdditionalMergePersonInfo["default"].prototype['email_messages_count'] = undefined;
/**
 * The count of activities related to the person
 * @member {Number} activities_count
 */

_AdditionalMergePersonInfo["default"].prototype['activities_count'] = undefined;
/**
 * The count of done activities related to the person
 * @member {Number} done_activities_count
 */

_AdditionalMergePersonInfo["default"].prototype['done_activities_count'] = undefined;
/**
 * The count of undone activities related to the person
 * @member {Number} undone_activities_count
 */

_AdditionalMergePersonInfo["default"].prototype['undone_activities_count'] = undefined;
/**
 * The count of files related to the person
 * @member {Number} files_count
 */

_AdditionalMergePersonInfo["default"].prototype['files_count'] = undefined;
/**
 * The count of notes related to the person
 * @member {Number} notes_count
 */

_AdditionalMergePersonInfo["default"].prototype['notes_count'] = undefined;
/**
 * The count of followers related to the person
 * @member {Number} followers_count
 */

_AdditionalMergePersonInfo["default"].prototype['followers_count'] = undefined;
/**
 * The date and time of the last incoming email associated with the person
 * @member {String} last_incoming_mail_time
 */

_AdditionalMergePersonInfo["default"].prototype['last_incoming_mail_time'] = undefined;
/**
 * The date and time of the last outgoing email associated with the person
 * @member {String} last_outgoing_mail_time
 */

_AdditionalMergePersonInfo["default"].prototype['last_outgoing_mail_time'] = undefined;
/**
 * The count of open deals related with the item
 * @member {Number} open_deals_count
 */

_AdditionalMergePersonInfo["default"].prototype['open_deals_count'] = undefined;
/**
 * The count of related open deals related with the item
 * @member {Number} related_open_deals_count
 */

_AdditionalMergePersonInfo["default"].prototype['related_open_deals_count'] = undefined;
/**
 * The count of closed deals related with the item
 * @member {Number} closed_deals_count
 */

_AdditionalMergePersonInfo["default"].prototype['closed_deals_count'] = undefined;
/**
 * The count of related closed deals related with the item
 * @member {Number} related_closed_deals_count
 */

_AdditionalMergePersonInfo["default"].prototype['related_closed_deals_count'] = undefined;
/**
 * The count of won deals related with the item
 * @member {Number} won_deals_count
 */

_AdditionalMergePersonInfo["default"].prototype['won_deals_count'] = undefined;
/**
 * The count of related won deals related with the item
 * @member {Number} related_won_deals_count
 */

_AdditionalMergePersonInfo["default"].prototype['related_won_deals_count'] = undefined;
/**
 * The count of lost deals related with the item
 * @member {Number} lost_deals_count
 */

_AdditionalMergePersonInfo["default"].prototype['lost_deals_count'] = undefined;
/**
 * The count of related lost deals related with the item
 * @member {Number} related_lost_deals_count
 */

_AdditionalMergePersonInfo["default"].prototype['related_lost_deals_count'] = undefined;
/**
 * The date of the next activity associated with the deal
 * @member {String} next_activity_date
 */

_AdditionalMergePersonInfo["default"].prototype['next_activity_date'] = undefined;
/**
 * The time of the next activity associated with the deal
 * @member {String} next_activity_time
 */

_AdditionalMergePersonInfo["default"].prototype['next_activity_time'] = undefined;
/**
 * The ID of the next activity associated with the deal
 * @member {Number} next_activity_id
 */

_AdditionalMergePersonInfo["default"].prototype['next_activity_id'] = undefined;
/**
 * The ID of the last activity associated with the deal
 * @member {Number} last_activity_id
 */

_AdditionalMergePersonInfo["default"].prototype['last_activity_id'] = undefined;
/**
 * The date of the last activity associated with the deal
 * @member {String} last_activity_date
 */

_AdditionalMergePersonInfo["default"].prototype['last_activity_date'] = undefined;
/**
 * The count of open participant deals related with the item
 * @member {Number} participant_open_deals_count
 */

_AdditionalMergePersonInfo["default"].prototype['participant_open_deals_count'] = undefined;
/**
 * The count of closed participant deals related with the item
 * @member {Number} participant_closed_deals_count
 */

_AdditionalMergePersonInfo["default"].prototype['participant_closed_deals_count'] = undefined;
var _default = MergePersonItem;
